...
const ProductSelector: React.FC<ProductSelectorProps> = ({
  ...
  console.log(
    selectedSku?.stocks?.reduce((acc, stock) => acc + stock?.quantity, 0)
  );
          ...
          <Box my={2}>
            <Grid2 container spacing={4}>
              <Grid2 sx={{ display: 'flex' }} size={6}>
                ...
                {selectedSku && (
                  <img
                    src={selectedSku?.imageUrl ?? productData?.data?.images[0]}
                    alt=''
                    style={{
                      width: '100%',
                      maxWidth: '60px',
          ...
          <Table sx={{}} aria-label='simple table'>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ width: '17%', px: 1 }} align='center'>
                  Tên
                </TableCell>
                <TableCell sx={{ width: '5%', px: 0 }} align='center'>
                  Ảnh
                </TableCell>
                <TableCell sx={{ width: '37%', px: 1 }} align='center'>
                  Phân loại
                </TableCell>
                <TableCell sx={{ width: '5%', px: 1 }} align='center'>
                  SL
                </TableCell>
                <TableCell sx={{ width: '13%', px: 1 }} align='center'>
                  Giá
                </TableCell>
                  ...
                  <TableRow
                    ...
                    <TableCell>
                      {item.skuAttributes.length ? (
                        ...
                        <Typography sx={{ fontSize: 13 }}>Không có</Typography>
                      )}
                    </TableCell>
